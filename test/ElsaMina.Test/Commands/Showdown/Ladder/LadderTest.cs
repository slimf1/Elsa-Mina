...
public class LadderCommandTest
{
    ...
    [Test]
    public async Task Test_Run_ShouldReplyWithNoPlayersMessage_WhenResponseIsNull()
    {
        // Arrange
        ...
        // Act
        await _ladderCommand.Run(_context);
    ...
    [Test]
    public async Task Test_Run_ShouldReplyWithNoPlayersMessage_WhenTopListIsNull()
    {
        // Arrange
    ...
    [Test]
    public async Task Test_Run_ShouldReplyWithNoPlayersMessage_WhenNoPlayersMatchPrefix()
    {
        // 
    ...
    [Test]
    public async Task Test_Run_ShouldSendHtml_WhenPlayersMatchPrefix()
    {
        // Arrange
        ...
        _templatesManager.GetTemplate(Arg.Any<string>(), Arg.Any<LadderTableViewModel>())
        ...
        // Assert
        await _templatesManager.Received().GetTemplate("Showdown/Ladder/LadderTable",
