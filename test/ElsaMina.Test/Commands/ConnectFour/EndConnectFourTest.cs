...
public class EndConnectFourTest
{
    ...
    [Test]
    public async Task Test_Run_ShouldCancelGameAndReplyCancelledMessage_WhenGameIsConnectFour()
    {
        // Arrange
    ...
    [Test]
    public async Task Test_Run_ShouldReplyOngoingGameMessage_WhenNoConnectFourGameExists()
    {
        // Arrange
        _context.Room.Returns(_room);
    ...
    [Test]
    public async Task Test_Run_ShouldReplyOngoingGameMessage_WhenRoomIsNull()
    {
        // Arrange
    ...
    [Test]
    public async Task Test_Run_ShouldReplyOngoingGameMessage_WhenRoomHasNoGame()
    {
        // Arrange
        _context.Room.Returns(_room);
