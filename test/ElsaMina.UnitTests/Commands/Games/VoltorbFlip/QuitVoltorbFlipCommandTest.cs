...
public class QuitVoltorbFlipCommandTest
{
    ...
    [Test]
    public async Task Test_RunAsync_ShouldCallQuitRound_WhenVoltorbFlipGameExists()
    {
        // Arrange
        ...
        // Assert
        await _voltorbFlipGame.Received(1).QuitRound(_sender);
    }
    ...
    {
        // Arrange
        _context.Target.Returns("nonexistent-room");
        ...
        // Assert
        await _voltorbFlipGame.DidNotReceive().QuitRound(Arg.Any<IUser>());
    }
