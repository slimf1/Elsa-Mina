...
public class EndTwentyFortyEightCommandTest
{
    ...
    private EndTwentyFortyEightCommand _command;
    ...
    public void SetUp()
    {
        ...
        _command = new EndTwentyFortyEightCommand(_roomsManager, _gameManager);
    ...
    [Test]
    public async Task Test_RunAsync_ShouldCancelGame_WhenGameExists()
    {
        ...
        await _game.Received(1).CancelAsync();
    }

    [Test]
    public async Task Test_RunAsync_ShouldReplyCancelled_WhenGameExists()
    {
        _context.Room.Returns(_room);
        _room.Game.Returns(_game);
        ...
        _context.Received(1).ReplyLocalizedMessage("tfe_game_cancelled");
    }
    ...
    public async Task Test_RunAsync_ShouldReplyNoGame_WhenRoomHasNoGame()
    {
        ...
        _context.Received(1).ReplyLocalizedMessage("tfe_game_no_game");
        await _game.DidNotReceive().CancelAsync();
    }
    ...
    public async Task Test_RunAsync_ShouldReplyNotOwner_WhenSenderIsNotOwner()
    {
        ...
        _context.Received(1).ReplyLocalizedMessage("tfe_game_not_owner");
        await _game.DidNotReceive().CancelAsync();
    }
    ...
    public async Task Test_RunAsync_ShouldCancelGame_WhenPmAndGameExistsForRoom()
    {
        ...
        _context.Sender.Returns(sender);
        _gameManager.GetGame("test-room", "testplayer").Returns(_game);
