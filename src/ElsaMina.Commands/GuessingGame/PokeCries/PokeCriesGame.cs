...
public class PokeCriesGame : GuessingGame
{
    ...
    private static readonly List<EasterEgg> EASTER_EGGS = [
        new() { Message = "<audio controls src=\"https://www.myinstants.com/media/sounds/euh-nique-ta-mere-marine-le-pen.mp3\"></audio>", Answers = ["Marine le Pen", "Le Pen"] },
        new() { Message = "<audio controls src=\"https://www.myinstants.com/media/sounds/nous-sommes-en-guerre_-macron-contre-le-coronavirus-2.mp3\"></audio>", Answers = ["Macron, Emmanuel Macron"] },
        new() { Message = "<audio controls src=\"https://www.myinstants.com/media/sounds/parce-que-cest-notre-projet_KwtXTe2.mp3\"></audio>", Answers = ["Macron", "Emmanuel Macron"] },
        new() { Message = "<audio controls src=\"https://www.myinstants.com/media/sounds/sardoche-mais-voila-mais-cetait-sur-en-fait_s9qhFsx.mp3\"></audio>", Answers = ["Sardoche"] },
    ]; 
