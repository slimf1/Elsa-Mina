...
public class StartFloodItCommand : Command
{
    ...
    private async Task HandlePrivateMessageAsync(IContext context)
    {
        ...
        {
            context.ReplyLocalizedMessage("fi_pm_missing_room");
            return;
        }
        ...
        if (room == null)
        {
            context.ReplyLocalizedMessage("fi_pm_invalid_room");
            return;
        }
        ...
        if (existingGame != null)
        {
            ...
            {
                context.ReplyLocalizedMessage("fi_game_round_active");
                return;
            }
    ...
    private async Task HandleRoomMessageAsync(IContext context)
    {
        ...
        if (room.Game is IFloodItGame existingGame)
        {
            if (!existingGame.IsStarted)
            {
                context.ReplyLocalizedMessage("fi_game_waiting");
                return;
            }
        ...
        if (room.Game != null)
        {
            context.ReplyLocalizedMessage("fi_game_already_running");
            return;
        }
